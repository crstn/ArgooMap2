...
class ElementHelper {
    ...
    public static native void setAttribute(JSObject elem, String attr,
            String value) /*-{
     elem[attr] = value;
     }-*/;

    public static native JSObject getAttributeAsJSObject(JSObject elem,
            String attr) /*-{
     var ret = elem[attr];
     return (ret === undefined) ? null : ret;
     }-*/;

    public static native Element getAttributeAsElement(JSObject elem,
            String attr) /*-{
     var ret = elem[attr];
     return (ret === undefined) ? null : ret;
     }-*/;
    ...
    public static native void setAttributeAsIntArray(JSObject elem,
            String attr, int[] value) /*-{
     elem[attr] = value;
     }-*/;

    public static native boolean getAttributeAsBoolean(JSObject elem,
            String attr) /*-{
     var ret = elem[attr];
     return (ret === undefined) ? null : ret;
     }-*/;

    public static JSObject arrayConvert(GoogleMapsWidget[] array) {
    ...
    public static native JSObject getElementsByTagName(Element parent,
            String tagName) /*-{
